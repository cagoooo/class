...
(function () {
    ...
    var API = {
        ...
        // 仍會留底，但成功操作併入每日戰報，避免把正常管理動作變成噪音。
        ...
        // 寵物事件：所有事件都會留底，成功的孵化、升級、撤銷、商店與設定
        // 一律併入每日戰報；真正失敗則走 petError → error 即時通知。
